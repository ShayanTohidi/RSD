...
Applying `fsd.test` and `ssd.test` functions, it can be seen that the first cultivar dominates by SSD, and not FSD. Below, we shows how to modify the plots based on your preferences.
